...
[**安装**](app/MCP-SETUP.zh-CN.md) · [**线上站**](https://vigilapp.vercel.app)
...
| 部署——MCP server 在 [vigil-mcp.usdhgwang.workers.dev](https://vigil-mcp.usdhgwang.workers.dev/health)、签名页只在那个 worker 的 `/sign`、介绍站 [vigilapp.vercel.app](https://vigilapp.vercel.app) | 完成 |
