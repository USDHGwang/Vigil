...
const en: Dict = {
  ...
  sign_fp_hint: "Compare with the one shown in the panel. If they match, the transaction was not swapped on the way.",
...
const zhCN: Dict = {
  ...
  sign_fp_hint: "跟面板上显示的核对一下。一样，代表这笔交易中间没有被换过。",
...
const zhTW: Dict = {
  ...
  sign_fp_hint: "跟面板上顯示的對一下。一樣，代表這筆交易中間沒有被換過。",
