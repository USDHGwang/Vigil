...
const en: Dict = {
  ...
  sign_risk_deposit: "Vault deposit: puts in {amount} (raw units) via {token} and sends the shares to {who}.",
  sign_risk_mint: "Vault mint: issues {amount} (raw units) of {token} shares to {who}.",
  sign_risk_withdraw: "Vault withdrawal: takes out {amount} (raw units) via {token}, from {owner}, paid to {who}.",
  sign_risk_redeem: "Vault redemption: burns {amount} (raw units) of {token} shares held by {owner}, paid to {who}.",
...
const zhCN: Dict = {
  ...
  sign_risk_deposit: "金库存入：透过 {token} 存入 {amount}（原始单位），份额发给 {who}。",
  sign_risk_mint: "金库铸造：发行 {amount}（原始单位）的 {token} 份额给 {who}。",
  sign_risk_withdraw: "金库提取：透过 {token} 取出 {amount}（原始单位），从 {owner} 的部位，付给 {who}。",
  sign_risk_redeem: "金库赎回：销毁 {owner} 持有的 {amount}（原始单位）{token} 份额，付给 {who}。",
  tx_fallback: "这笔交易",
...
const zhTW: Dict = {
  ...
  sign_risk_deposit: "金庫存入：透過 {token} 存入 {amount}（原始單位），份額發給 {who}。",
  sign_risk_mint: "金庫鑄造：發行 {amount}（原始單位）的 {token} 份額給 {who}。",
  sign_risk_withdraw: "金庫提取：透過 {token} 取出 {amount}（原始單位），從 {owner} 的部位，付給 {who}。",
  sign_risk_redeem: "金庫贖回：銷毀 {owner} 持有的 {amount}（原始單位）{token} 份額，付給 {who}。",
  tx_fallback: "這筆交易",
