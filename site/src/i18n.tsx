...
export const DICT = {
  en: {
    ...
    heroSub: "The watchman sees, reports, and never decides for you.",
    ...
    archTitle: "The journey of one transaction.",
    ...
    footerTag: "Vigil · the night watchman",
    navGap: "The gap",
    navHow: "How it works",
    ...
    addPage: {
      ...
      howClaudeWeb: "In claude.ai → Settings → Connectors, add the hosted endpoint: https://vigil-mcp.usdhgwang.workers.dev/mcp. Renders the full panel.",
      stepsClaudeWeb: [
      ...
      howGpt: "In ChatGPT → Settings → Apps & Connectors, add the hosted endpoint: https://vigil-mcp.usdhgwang.workers.dev/mcp. Renders the full panel.",
      stepsChatGPT: [
      ...
      remoteNote: "Claude Desktop Connectors and ChatGPT require an https URL. Ours is live at https://vigil-mcp.usdhgwang.workers.dev/mcp — or run pnpm mcp:http and tunnel your own.",
      copy: "Copy",
      copied: "Copied",
  ...
  "zh-TW": {
    ...
    addPage: {
      ...
      localTag: "本機安裝——今天就能用",
      cardAny: "任何 MCP host",
      howClaudeWeb: "在 claude.ai → Settings → Connectors 加入託管端點：https://vigil-mcp.usdhgwang.workers.dev/mcp。渲染完整面板。",
      stepsClaudeWeb: [
        "開啟 claude.ai → Customize → Connectors",
        "按 + → Add custom connector，貼上下方 URL",
        "按 Add——完成連線（Free 方案可用一個 connector）",
      ],
      howGpt: "在 ChatGPT → Settings → Apps & Connectors 加入託管端點：https://vigil-mcp.usdhgwang.workers.dev/mcp。渲染完整面板。",
      stepsChatGPT: [
      ...
      remoteTag: "遠端端點",
      remoteNote: "Claude Desktop Connectors 與 ChatGPT 需要 https 網址。正式端點已上線：https://vigil-mcp.usdhgwang.workers.dev/mcp——或自己跑 pnpm mcp:http 開隧道。",
      copy: "複製",
      copied: "已複製",
  ...
  "zh-CN": {
    ...
    addPage: {
      ...
      localTag: "本地安装——今天就能用",
      cardAny: "任何 MCP host",
      howClaudeWeb: "在 claude.ai → Settings → Connectors 添加托管端点：https://vigil-mcp.usdhgwang.workers.dev/mcp。渲染完整面板。",
      stepsClaudeWeb: [
        "打开 claude.ai → Customize → Connectors",
        "点击 + → Add custom connector，粘贴下方 URL",
        "点击 Add——完成连接（Free 方案可用一个 connector）",
      ],
      howGpt: "在 ChatGPT → Settings → Apps & Connectors 添加托管端点：https://vigil-mcp.usdhgwang.workers.dev/mcp。渲染完整面板。",
      stepsChatGPT: [
      ...
      remoteTag: "远程端点",
      remoteNote: "Claude Desktop Connectors 与 ChatGPT 需要 https 网址。正式端点已上线：https://vigil-mcp.usdhgwang.workers.dev/mcp——或自己跑 pnpm mcp:http 开隧道。",
      copy: "复制",
      copied: "已复制",
  ...
  ja: {
    ...
    heroReport: "報告する。",
    heroDecide: "決めるのはあなた。",
    heroSub: "夜警は見て、報告し、決してあなたの代わりに決めない。",
    ...
    addPage: {
      ...
      cardAny: "任意の MCP ホスト",
      howClaudeWeb: "claude.ai → Settings → Connectors でホスト版エンドポイント（https://vigil-mcp.usdhgwang.workers.dev/mcp）を追加。フルパネルで表示されます。",
      stepsClaudeWeb: [
        "claude.ai → Customize → Connectors を開く",
        "+ → Add custom connector を選び、下の URL を貼り付け",
        "Add を押して接続完了（Free プランでも 1 つ使えます）",
      ],
      howGpt: "ChatGPT → Settings → Apps & Connectors でホスト版エンドポイント（https://vigil-mcp.usdhgwang.workers.dev/mcp）を追加。フルパネルで表示されます。",
      stepsChatGPT: [
      ...
      remoteNote: "Claude Desktop Connectors と ChatGPT は https の URL が必要です。正式エンドポイントは https://vigil-mcp.usdhgwang.workers.dev/mcp で稼働中——または pnpm mcp:http を自分で起動してトンネルを張ってください。",
      copy: "コピー",
      copied: "コピー済み",
  ...
  ko: {
    ...
    heroSub: "야경꾼은 보고, 보고하며, 결코 당신을 대신해 결정하지 않는다.",
    ...
    addPage: {
      ...
      cardAny: "모든 MCP 호스트",
      howClaudeWeb: "claude.ai → Settings → Connectors에서 호스팅 엔드포인트(https://vigil-mcp.usdhgwang.workers.dev/mcp)를 추가하세요. 전체 패널로 렌더링됩니다.",
      stepsClaudeWeb: [
        "claude.ai → Customize → Connectors 열기",
        "+ → Add custom connector 선택 후 아래 URL 붙여넣기",
        "Add 클릭——연결 완료 (Free 요금제도 1개 사용 가능)",
      ],
      howGpt: "ChatGPT → Settings → Apps & Connectors에서 호스팅 엔드포인트(https://vigil-mcp.usdhgwang.workers.dev/mcp)를 추가하세요. 전체 패널로 렌더링됩니다.",
      stepsChatGPT: [
      ...
      remoteTag: "원격 엔드포인트",
      remoteNote: "Claude Desktop Connectors와 ChatGPT는 https URL이 필요합니다. 공식 엔드포인트가 https://vigil-mcp.usdhgwang.workers.dev/mcp에서 운영 중입니다——또는 pnpm mcp:http를 직접 실행해 터널을 뚫으세요.",
      copy: "복사",
      copied: "복사됨",
