...
Permit2, `transferFrom`, and the ERC-4626 vault calls — and prints what the bytes do, above the transaction
...
`pnpm check`: **372 tests**. `MOSS_SKIP_E2E=1` runs 346 of them with no network
